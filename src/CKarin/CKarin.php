<?php
/**
* Main class for Karin, holds everything.
*
* @package KarinCore
*/
class CKarin implements ISingleton {
  ...
  private static $instance = null;
    ...
    * @return CKarin The instance of this class.
    */
   public static function Instance() {
      if(self::$instance == null) {
         self::$instance = new CKarin();
      }
   ...
   protected function __construct() {
     // time page generation
      ...
      $ka = &$this;
      require(KARIN_SITE_PATH.'/config.php');
 ...
 public function ThemeEngineRender() {
    ...
    $themePath         = KARIN_INSTALL_PATH . '/' . $this->config['theme']['path'];
    ...
    if(isset($this->config['theme']['parent'])) {
      $parentPath = KARIN_INSTALL_PATH . '/' . $this->config['theme']['parent'];
      $parentUrl        = $this->request->base_url . $this->config['theme']['parent'];
    }
    
    // Add stylesheet name to the $mo->data array
    $this->data['stylesheet'] = $this->config['theme']['stylesheet'];
    
    // Make the theme urls available as part of $mo
    ...
    $ka = &$this;
    // First the default Morris themes/functions.php
    include(KARIN_INSTALL_PATH . '/themes/functions.php');
  ...
  /**
   * Draw HTML for a menu defined in $ka->config['menus'].
   *
